...
private class CheckNotNullLowering(private val backendContext: JvmBackendContext) : IrElementTransformerWithScopeOwner(),
    FileLoweringPass {
    ...
    override fun visitCall(expression: IrCall, data: IrSymbolOwner?): IrElement {
        ...
        return backendContext.createIrBuilder(data!!.symbol, expression.startOffset, expression.endOffset).irBlock {
